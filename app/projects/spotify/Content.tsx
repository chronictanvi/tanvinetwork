          ...
          /> */}
            <div className=" max-w-4xl gap-2 ">
              <div className=" basis-1/2 pb-12 ">
                ...
                <p className="pb-5">
                  {" "}
                  Japan is distinct from other markets. There is specific
                  cultural value placed on restricted items and the desire to be
        ...
        <section className="bg-white  px-5 py-32 text-black">
            ...
            <div className="">
              <div className=" basis-1/2 pb-5 ">
                ...
                <p className="py-5 pb-24">
                  ...
                  much" may come across as confrontational and lacks the power
                  to inspire further action. Our proposal is modular — Emphasize
                  the narrative and exclude elements that don't captivate
                  interest. It allows for a curated set of data stories created
                  for specific users.
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-3xl pt-12 ">
            ...
            <p className="py-5">
              ...
              considerations I made were around complexity of visual
              information, layout and modularity.
            </p>
            ...
            <div className="mx-auto flex flex-col gap-24 md:flex-row">
              <div className="basis-1/2">
                ...
                <p>
                  ...
                  example, this data story is packed with information — there is
                  a subset of fans, minutes, song that is most listened to, how
            ...
            <div className="mx-auto gap-24 py-12 ">
              <div className=" my-5">
                ...
                <p>
                  ...
                  audience, retaining only the essential information on each
                  data card. I wanted to develop the cards in a manner that they
                  could be flexible in how much space they take up.
                </p>
              </div>
